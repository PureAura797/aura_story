...
const securityHeaders = [
  ...
  // Content Security Policy
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://raw.githack.com",
      "media-src 'self' blob: https://*.supabase.co",
      "connect-src 'self' https://*.supabase.co https://*.vercel-insights.com https://*.vercel-analytics.com https://raw.githack.com",
