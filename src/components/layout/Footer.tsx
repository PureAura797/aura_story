      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-10 pb-16 grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-8 border-t border-white/10 pt-12">
        ...
        <nav aria-label="Services navigation">
          ...
          <div className="flex flex-col gap-3">
            <button onClick={() => scrollToSection("services")} className="text-sm text-neutral-500 hover:text-white transition-colors text-left cursor-pointer">{t("footer.services.1")}</button>
            <button onClick={() => scrollToSection("pricing")} className="text-sm text-neutral-500 hover:text-white transition-colors text-left cursor-pointer">{t("footer.services.2")}</button>
            <button onClick={() => scrollToSection("portfolio")} className="text-sm text-neutral-500 hover:text-white transition-colors text-left cursor-pointer">{t("footer.services.3")}</button>
            <button onClick={() => scrollToSection("reviews")} className="text-sm text-neutral-500 hover:text-white transition-colors text-left cursor-pointer">{t("footer.services.4")}</button>
          </div>
        </nav>
        ...
        <nav aria-label="Company navigation">
          ...
          <div className="flex flex-col gap-3">
            <button onClick={() => scrollToSection("process")} className="text-sm text-neutral-500 hover:text-white transition-colors text-left cursor-pointer">{t("footer.company.1")}</button>
            <button onClick={() => scrollToSection("equipment")} className="text-sm text-neutral-500 hover:text-white transition-colors text-left cursor-pointer">{t("footer.company.2")}</button>
            <button onClick={() => scrollToSection("expertise")} className="text-sm text-neutral-500 hover:text-white transition-colors text-left cursor-pointer">{t("footer.company.3")}</button>
            <button onClick={() => scrollToSection("faq")} className="text-sm text-neutral-500 hover:text-white transition-colors text-left cursor-pointer">{t("footer.company.4")}</button>
          </div>
        </nav>
