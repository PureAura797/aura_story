...
const DEFAULT_EQUIPMENT: EquipmentItem[] = [
  ...
  { id: "2", name: "Генератор холодного тумана", tag: "дезинфекция", specs: "5L / 800W", purpose: "Распыление дезинфицирующих составов мельчайшими каплями по всему помещению.", details: "Профессиональный генератор холодного тумана для равномерного нанесения биоцидных и дезинфицирующих составов. Размер капель 5–50 мкм — проникает в щели, вентиляцию, за мебель. Бак 5 литров, мощность 800 Вт. Обрабатывает до 200 м² за один заход.", image: "/equipment/hydroxyl.webp", color: "#38bdf8", published: true, sort_order: 1 },
  { id: "3", name: "Влагомеры", tag: "диагностика", specs: "0–100%", purpose: "Точное измерение влажности стен, полов и перекрытий для контроля качества сушки.", details: "Профессиональные влагомеры для определения уровня влажности строительных материалов. Контактные и бесконтактные модели для разных типов поверхностей. Позволяют объективно оценить степень просушки после затоплений и мокрой обработки. Точность измерений ±1%.", image: "/equipment/fogger.webp", color: "#d4a574", published: true, sort_order: 2 },
  { id: "4", name: "Сухой туман", tag: "устранение запахов", specs: "до 200 м²", purpose: "Полная нейтрализация стойких запахов на молекулярном уровне без химических остатков.", details: "Технология сухого тумана для устранения запахов гари, табака, органики и других стойких загрязнений воздуха. Микрочастицы нейтрализатора проникают в структуру материалов — ткани, бетон, дерево — и разрушают молекулы запаха. Безопасен для мебели и отделки.", image: "/equipment/atp.webp", color: "#a78bfa", published: true, sort_order: 3 },
