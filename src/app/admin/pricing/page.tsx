        ...
        {items.sort((a, b) => a.sort_order - b.sort_order).map((item, idx) => (
          <div key={item.id} className="border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl backdrop-saturate-150 p-5">
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              <div>
                <label className="text-[11px] text-neutral-600 uppercase tracking-wider mb-1 block">Цена (₽)</label>
                <input
                  type="number"
                  value={item.price}
              ...
              <div>
                <label className="text-[11px] text-neutral-600 uppercase tracking-wider mb-1 block">Площадь</label>
                <input
                  type="text"
                  value={item.area}
