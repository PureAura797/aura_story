export default function AdminLoader({ label = "Загрузка" }: { label?: string }) {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] gap-6">
      ...
      <p className="text-[10px] uppercase tracking-[0.25em] text-neutral-600 font-medium animate-pulse">{label}</p>
    </div>
  );
}
